...
def render_operator_controls(conn, latest_fpl_deadline: dict[str, Any] | None) -> None:
    ...
    with control_right:
        ...
        pipeline_confirmed = st.checkbox(
            "I understand this runs a write-capable weekly pipeline.",
            key="weekly_pipeline_confirmation",
        ...
        if st.button(
            ...
            disabled=bool(reasons) or not pipeline_confirmed,
        ):
            st.session_state["weekly_pipeline_confirmation"] = False
